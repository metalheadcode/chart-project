...
function IndicatorList({ indicators, setIndicators, setOpenEMAConfigModal }: { indicators: string[], setIndicators: (indicators: string[]) => void, setOpenEMAConfigModal: (openEMAConfigModal: { indicatorTitle: string, isOpen: boolean }) => void }) {
  return (
    <div className="p-2">
